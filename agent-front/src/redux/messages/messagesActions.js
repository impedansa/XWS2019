...
export const fetchInbox = (selfId) => {
    return (dispatch) => {
        ...
        axios.get('http://localhost:8081/users/' + selfId + '/messages')
            .then((response) => {
...
export const fetchChat = (selfId, otherId) => {
    return (dispatch) => {
        ...
        axios.get('http://localhost:8081/users/' + selfId + '/messages/with/' + otherId)
        .then((response) => {
...
export const sendMessage = (selfId, message) => {
    return (dispatch) => {
        ...
        axios.post('http://localhost:8081/users/' + selfId + '/messages', message)
            .then((response) => {
