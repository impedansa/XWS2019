...
import com.megatravel.agent.service.ApartmentsService;
...
public class ApartmentsController {
	...
	public ResponseEntity<ApartmentDTO> createApartment(@RequestBody ApartmentDTO apartmentDTO) {
		return new ResponseEntity<ApartmentDTO>(new ApartmentDTO(apartmentsService.createApartment(apartmentDTO)), HttpStatus.CREATED);
	}
}
